...
int64 CTransaction::nMinTxFee = 0;  // Override with -mintxfee
                              ...
                              enum GetMinFee_mode mode) const
{
    ...
    if (fAllowFree)
    {
        if (nBlockSize == 1)
        {
            ...
            // (about 4500 MAX if made of 50 MAX inputs)
            if (nBytes < 10000)
                nMinFee = 0;
        }
        else
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0000000a23e3eb42dc87b61d4015c80ffd85471d34e2c7210c7ca63b78a58612");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nNonce   = nNonceGenesisBlock;

        if (fTestNet)
        {
            block.nTime    = 1390434081;
            block.nNonce   = 1582968;
        }
